...
export default function DiaryLog() {
  ...
  return (
    <>
      ...
      <div className="w-full overflow-hidden rounded-lg shadow-xs flex p-20">
      ...
      <button className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onClick={() => router.back()}>Voltar</button>
      </div>
    </>
  );
}
